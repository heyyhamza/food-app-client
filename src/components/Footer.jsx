  ...
  return (
    <div>
      ...
      <footer className="footer xl:px-24 py-10 px-4 text-base-content">
        <aside>
          <img src="/logo.png" alt="QuickBite Logo" height="100" width="100" />
          <h2 className="text-2xl font-bold text-green mt-2">QuickBite</h2>

          <p className="my-3 md:w-52 text-gray-600">
        ...
        <nav>
          ...
          <a className="link link-hover">support@quickbite.com</a>
          <a className="link link-hover">New Delhi, India</a>
